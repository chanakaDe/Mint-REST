/**
 * save all kding of mailtemplate string in a varible and use as necessary
 * eg : let varifyUserEmailTemplate = ''
 */
let welcomeMail = {
    subject : "WELCOME TO BLOGGER ✔",
    template : '<div style="padding-left: 50px;padding-right: 50px;">' +
